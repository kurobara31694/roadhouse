...
<head>
  ...
  <title>Fellowship | Complete Your Profile</title>
</head>
...
<body>
    ...
    <div class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link active" href="register.php">Edit Profile</a>
        </li>
    </div>
  ...
  if (!empty($_SESSION['user_name'])) {
    ?>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="input-group">
      <div class="container" id="register">
        <h1>Complete Your Profile</h1>
        <h2>Fill out the information and finish creating your account!</h2>

        <label> Company Name</label>

        <input class="form-control" type="text" name="fullname" placeholder="Please enter the Company name. Ex: Elfheim" required>


        <label> Address</label>

        <input class="form-control" type="text" name="address1" placeholder="Please enter address with the Street number. Ex:123 Gondor Dr." required>
        ...
        <input class="form-control" type="number" maxlength="9" name="zipcode" required>
